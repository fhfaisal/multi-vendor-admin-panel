...
Color secondaryColorWithOpacity=const Color(0xff01BDF3).withOpacity(0.2);
const Color primaryColors=Color(0xffFFC300);
const Color appbarColor=Color(0xff6495ED);
